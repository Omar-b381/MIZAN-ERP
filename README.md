...
- **طباعة المستندات والفواتير مع الترويسة المعتمدة (A4 Letterhead Printing)**:
  - دعم فواتير المبيعات، فواتير المشتريات، أوامر البيع والشراء، وسندات القبض والصرف.
  - هوية الشركات الكاملة: الاسم، السجل التجاري، الرقم الضريبي، بيانات الاتصال، ورمز الاستجابة السريع (QR Code).
  - **محرك التفقيط المالي باللغة العربية (Arabic Tafqeet)**: تحويل المبالغ النقدية التلقائي إلى كلمات عربية نصية معتمدة.
  - إعدادات طباعة متقدمة متوافقة مع `window.print()` وقواعد CSS الخاصة بالطباعة (`@media print`).
